create schema `order0` collate utf8_general_ci;

create table if not exists `order0`.`order1`
(
    id              bigint                     not null
        primary key,
...
',
    ...
    comment '订单表(正向)';
create table if not exists `order0`.`order2`
(
    id              bigint                     not null
        primary key,
    order_id        bigint                     not null comment '订单id',
...
',
    ...
    comment '订单表(正向)';
create table if not exists `order0`.`order3`
(
    id              bigint                     not null
        primary key,
    order_id        bigint                     not null comment '订单id',
...
',
    ...
    comment '订单表(正向)';
create table if not exists `order0`.`order4`
(
    id              bigint                     not null
        primary key,
    order_id        bigint                     not null comment '订单id',
...
',
    ...
    comment '订单表(正向)';
create table if not exists `order0`.`order5`
(
    id              bigint                     not null
        primary key,
    order_id        bigint                     not null comment '订单id',
...
',
    ...
    comment '订单表(正向)';
create table if not exists `order0`.`order6`
(
    id              bigint                     not null
        primary key,
    order_id        bigint                     not null comment '订单id',
...
',
    ...
    comment '订单表(正向)';
create table if not exists `order0`.`order7`
(
    id              bigint                     not null
        primary key,
    order_id        bigint                     not null comment '订单id',
...
',
    ...
    comment '订单表(正向)';
create table if not exists `order0`.`order8`
(
    id              bigint                     not null
        primary key,
    order_id        bigint                     not null comment '订单id',
...
',
    ...
    comment '订单表(正向)';
create table if not exists `order0`.`order9`
(
    id              bigint                     not null
        primary key,
    order_id        bigint                     not null comment '订单id',
...
',
    ...
    comment '订单表(正向)';
create table if not exists `order0`.`order10`
(
    id              bigint                     not null
        primary key,
    order_id        bigint                     not null comment '订单id',
...
',
    ...
    comment '订单表(正向)';
create table if not exists `order0`.`order11`
(
    id              bigint                     not null
        primary key,
    order_id        bigint                     not null comment '订单id',
...
',
    ...
    comment '订单表(正向)';
create table if not exists `order0`.`order12`
(
    id              bigint                     not null
        primary key,
    order_id        bigint                     not null comment '订单id',
...
',
    ...
    comment '订单表(正向)';
create table if not exists `order0`.`order13`
(
    id              bigint                     not null
        primary key,
    order_id        bigint                     not null comment '订单id',
...
',
    ...
    comment '订单表(正向)';
create table if not exists `order0`.`order14`
(
    id              bigint                     not null
        primary key,
    order_id        bigint                     not null comment '订单id',
...
',
    ...
    comment '订单表(正向)';
create table if not exists `order0`.`order15`
(
    id              bigint                     not null
        primary key,
    order_id        bigint                     not null comment '订单id',
...
',
    ...
    comment '订单表(正向)';
create table if not exists `order0`.`order16`
(
    id              bigint                     not null
        primary key,
    order_id        bigint                     not null comment '订单id',
