...
public class JdkProxy implements InvocationHandler, ProxyFactory {
  ...
  public GenericService genericServiceProxy(RegistryProtocol protocol, String group, String version) {
  ...
  public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
    ...
    if (GenericService.class.isAssignableFrom(serviceClass)) {
      ...
      invoker = invokerMap.computeIfAbsent(serviceClass, k -> protocol.getInvoker(serviceClass, group, version));
    } else {
